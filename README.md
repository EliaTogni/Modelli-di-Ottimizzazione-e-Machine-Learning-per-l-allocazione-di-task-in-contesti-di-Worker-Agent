...
Our results are reported in Table \ref{tab:humansVSMIP} which includes in turn the match level, the reference assignment policy, the corresponding value of successful tasks in both Round 2 and Round 9.
